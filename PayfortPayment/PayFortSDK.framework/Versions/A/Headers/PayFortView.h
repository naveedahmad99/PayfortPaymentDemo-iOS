...
@property (weak, nonatomic) IBOutlet PFKJVFloatLabeledTextField *CardNumberTxt;


@property (weak, nonatomic) IBOutlet PFKJVFloatLabeledTextField *CVCNumberTxt;

@property (weak, nonatomic) IBOutlet PFKJVFloatLabeledTextField *ExpDateTxt;
